...
# Script to create methylation proportions files from raw counts files for 5mC and 5hmC datasets. As input, it takes .txt files with the following columns: chr, start, end, N (depth), X (methylated reads), strand. It takes data originated with modkit.
