# This script calculates the reproducibility of methylation levels at the site level for 5mC in CpG context. 
# It takes as input the output of script 06.01, which are TXT files with the following columns: 
...
home <- path.expand("~")
path_write <- file.path(home, "Reproducibility", "Site-level", mod) # Path to write output files
dir.create(path_write, recursive = TRUE, showWarnings = FALSE)

dir <- file.path(home, "Data_methylation", "datasets_proportions", mod) # Output of script 06.01
