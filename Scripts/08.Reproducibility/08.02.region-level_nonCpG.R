...
home <- path.expand("~")
path_write <- file.path(home, "Reproducibility", "Region-level", mod, strand) # Path to write output files
...
# List all files in the directory that fulfill the pattern of mod and strand
files <- list.files(
  path = dir,
